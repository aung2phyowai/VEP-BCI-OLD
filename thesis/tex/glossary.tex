...
\newglossaryentry{dendrite}{
	name = dendrite,
	description = {-- nerve ending through which neurons receive signals.}
}
\newglossaryentry{axon}{
	name = axon,
	description = {-- nerve fibre through which neurons send signals.}
}
\newglossaryentry{synapse}{
	name = synapse,
	description = {-- a connection between neurons.}
}
...
\newglossaryentry{membrane potential}{
	...
	description = {-- difference in electric potential between the inside of the neuron and the extracellular fluid around the neuron.}
}
\newglossaryentry{resting state}{
	name = resting state,
	description = {-- state of a neuron that is not exited and not sending signals at the moment.}
}
\newglossaryentry{resting potential}{
	name = resting potential,
	description = {-- membrane potential of a neuron at a resting state.}
}
\newglossaryentry{action potential}{
	name = action potential,
	description = {-- event of sending signals used by neurons.}
}
...
\newglossaryentry{peripheral vision}{
	...
	description = {-- not the centre of gaze but the area that is around the centre and is not seen clearly.}
}
\newglossaryentry{fundamental frequency}{
	name = fundamental frequency,
	description = {-- frequency of the component of a signal that has lowest frequency among all the frequency components.}
}
\newglossaryentry{sampling rate}{
	name = sampling rate,
	description = {-- rate at which samples are obtained for example from an EEG device.}
}
...
\newglossaryentry{target}{
	name = target,
	description = {-- visual stimuli of VEP-based BCI}
}
