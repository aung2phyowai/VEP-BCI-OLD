...
%In conclusion the flickering of a target can be represented with a function of state versus time. This function can be one of three different waveforms.
